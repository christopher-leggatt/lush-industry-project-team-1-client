...
const CartItem = ({ product }) => {
    const { product_name, product_price, count, product_image, product_inshop_stock, product_online_stock, purchaseType, id } = product;
    ...
    const handleIncrease = () => {
        if (purchaseType === "inshop" && count < product_inshop_stock) {
            increaseCount(id);
        } else if (purchaseType === "online" && count < product_online_stock) {
            increaseCount(id);
        }
      };
